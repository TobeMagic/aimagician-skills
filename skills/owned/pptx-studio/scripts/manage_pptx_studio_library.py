...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("command", choices=("runtime-check", "plan", "apply", "verify", "recover", "promote-components", "verify-component-promotion", "render", "compile", "refresh-render-index", "rebuild-catalog", "query", "query-components", "query-batch", "inspect-deck", "plan-style-cluster", "probe-cover", "probe-page", "compose", "verify-replay", "preflight", "validate-fact-store", "bind-outline", "adapt", "assemble", "vision-plan", "vision-prompt", "vision-ingest", "vision-run", "vision-run-range", "curate-components"))
