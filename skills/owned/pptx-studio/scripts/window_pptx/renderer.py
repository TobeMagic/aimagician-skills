...
class PowerPointRenderer:
        ...
        for render_slide in plan.slides:
            ...
            for group_id in sorted(groups):
                ...
                try:
                    ...
                    group.Name = group_id
                    group.Tags.Add("pptx-studio:group", group_id)
                except Exception as exc:
                    raise RenderError(
    ...
    def _render_master(self, plan: RenderPlan, presentation: Any) -> None:
        ...
        shape.Tags.Add("pptx-studio:id", "master.background")
        shape.Fill.Solid()
    ...
    def _render_object(
        ...
        shape.Tags.Add("pptx-studio:id", item.id)
        shape.Tags.Add("pptx-studio:component", item.component)
        shape.Tags.Add("pptx-studio:editable", "true")
    ...
    def _render_diagram(
        ...
        frame.Tags.Add("pptx-studio:diagram-frame", spec.diagram_type)
        frame.Tags.Add("pptx-studio:editable", "true")
        frame.Fill.Solid()
        ...
        for index, (node, box) in enumerate(zip(spec.nodes, boxes), start=1):
            ...
            node_shape.Tags.Add("pptx-studio:diagram", spec.diagram_type)
            node_shape.Tags.Add("pptx-studio:editable", "true")
        ...
        group.Tags.Add("pptx-studio:diagram", spec.diagram_type)
        group.Tags.Add("pptx-studio:editable", "true")
        return group
