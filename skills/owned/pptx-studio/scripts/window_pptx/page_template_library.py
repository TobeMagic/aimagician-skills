...
CONFIG_PATH = Path("~/.config/pptx-studio/library.json").expanduser()
...
def resolve_private_root(
    *,
    ...
    raise PageTemplateError(
        ...
        "WINDOW_PPTX_PRIVATE_ROOT, or write ~/.config/pptx-studio/library.json"
    )
...
def compile_page_templates(
    ...
    *,
    library_id: str = "pptx-studio-gaojie-certified-core-v4",
) -> LibraryIndex:
...
def compile_reference_deck(
    ...
    *,
    library_id: str = "pptx-studio-reference-work-summary-v1",
) -> LibraryIndex:
