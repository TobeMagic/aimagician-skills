...
5. keep scripts, logs, media inventory, exports, and audits under `.pptx-studio/`
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command \
  "python 'D:\path\to\project\.pptx-studio\complete_homework.py'"
```
...
- use the clipped PNG in PowerPoint, and keep the generated asset in `.pptx-studio/generated_assets*`
