...
- Write all logs under `.pptx-studio/logs/`.
- Write generated assets under `.pptx-studio/generated_assets/`.
- Export review images under `.pptx-studio/exports/`.
...
```powershell
python C:\ppt-project\.pptx-studio\scripts\run_project.py
```
