...
```powershell
python ~/.codex/skills/pptx-studio/scripts/window_pptx_automation.py `
...
- Record the final local asset path and used slide/module in `.pptx-studio/asset_manifest.json`.
