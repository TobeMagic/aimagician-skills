...
| Native editable `.pptx`, PowerPoint template, slide master, or Office-compatible deck | `window-pptx` | The PPT skill owns generation, editing, rendering, and Office QA. |
