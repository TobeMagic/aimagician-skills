...
| Native editable `.pptx`, PowerPoint template, slide master, or Office-compatible deck | `pptx-studio` | The PPT skill owns generation, editing, rendering, and Office QA. |
