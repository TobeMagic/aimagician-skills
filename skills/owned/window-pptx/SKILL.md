...
5. Choose native COM implementation first.
6. Generate a concrete Windows Python script in `.window-pptx/`.
7. Execute the script from Windows PowerShell or CMD.
8. Save outputs under `output/`.
9. Verify acceptance criteria.
10. Report generated files, unresolved ambiguities, and any plugin limitations.
