...
REFERENCE_PLAN = Path("/home/aimagician/tmp/window-pptx-work-report-clean-v3/.window-pptx/audits/reference-assembly-plan.json")
REFERENCE_OUTPUT = Path("/home/aimagician/tmp/window-pptx-work-report-clean-v3/output/reference-final-approved.pptx")
