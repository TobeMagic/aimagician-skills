...
description: "Use this skill whenever the user wants to create, read, edit, or
  ...
  documents with formatting like tables of contents, headings, page numbers, or
  letterheads. Also use when extracting or reorganizing content from .docx
  ...
  'letter', 'template', or similar deliverable as a Word or .docx file, use this
